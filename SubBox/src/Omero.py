...
if __name__ == "__main__":
    ...
    p = Proxy()
    m = PlatformMonitor([monitors.WatchEventType.Creation,monitors.WatchEventType.Modification], monitors.PathMode.Follow, "/Users/paganotti/SubBox", [], [], True, True, p)
    try:
        m.start()
    except:
        m.stop()